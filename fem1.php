...
<html>
  ...
  <a href="perfumef18.php" class="btn btn-primary">Informações</a>  
  </div>
</div>
...
Seu enorme sucesso se deve à criação das mais cobiçadas roupas, acessórios e perfumes, que se tornaram clássicos imediatos na moda mundial.</p>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Sweet Hope La Rive abre com o toque adocicado de frutas e depois envolve com a ternura de flores como tuberosa e jasmim. Por fim, intensifica com as notas quentes de baunilha e amêndoas, que aguçam a imaginação.
